					...
					<div class="input-group">
						<div class="custom-file">
							<input type="file" class="custom-file-input" 
								name="uploadFile" id="input_imgs" multiple="multiple" disabled /> 
...
$(function(){
	...
	$("#uploadBtn").on("click",function(e){
		...
		*/
		...
		// ATTACH 테이블의 user_no 컬럼의 데이터에는 bookId가 들어가야된다!
		// ATTACH 테이블 seq 컬럼의 데이터는 1부터 1씩 자동 증가!
		$.ajax({
